...
import import_Red from '../assets/image/svg/import_Red_Ellips.svg'
const Impact = () => {
  return (
    <div className='bg-impactBg bg-black mt-[-2px] relative' id='section_4'>
        ...
        <div className='flex flex-row flex-wrap -mx-3 z-20 pt-[102px] max-lg:pt-[90px] max-md:pt-[60px] max-sm:pt-12 pb-[34px]'>
          <div className='flex items-center z-20 flex_wrap justify-center gap-9 max-xl:gap-6 max-lg:gap-9' data-aos="zoom-in">
            ...
            <div className='relative'>
              ...
              <img src={import_Red} alt="import_Red" className=' absolute pointer-events-none top-[-120px] z-0 left-0' />
            </div>
      ...
      <img src={clients_Right} className='absolute left-[0px] z-0 pointer-events-none top-[-290px]' alt="clients_Right" />
    </div>
  )
}
