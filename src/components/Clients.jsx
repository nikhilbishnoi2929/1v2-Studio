...
const Clients = () => {
  ...
  return (
    ...
    <Slider {...settings}>
      ...
      <div className='mx-auto  bg-hagenes_Bg bg-no-repeat bg-100% max-w-[1041px] max-xl:pr-[30px] max-sm:pr-[15px] max-sm:pl-[15px] max-xl:pl-[30px] pt-[42px] pr-[60px] pb-[41px] pl-[59px]'>
          <div className=' flex lg:flex-row flex-wrap -mx-3 flex-col-reverse '>
            <div className='lg:w-8/12 w-12/12 px-3 flex justify-center max-lg:pt-12 max-md:pt-8'>
            ...
            <div className=' lg:w-4/12 w-12/12 px-3 flex justify-center lg:justify-start'>
              <img src={girl_Img} className=' max-w-[289px] z-30 relative' alt="girl_img" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className='pt-[113px]  max-sm:pt-12 max-md:pt-[80px] max-lg:pt-[90px]'>
      <div className='mx-auto bg-hagenes_Bg bg-no-repeat bg-100% max-w-[1041px] max-xl:pr-[30px] max-xl:pl-[30px] pt-[42px] pr-[60px] pb-[41px] pl-[59px]'>
          <div className=' flex lg:flex-row flex-wrap -mx-3 flex-col-reverse '>
            <div className='lg:w-8/12 w-12/12 px-3 flex justify-center max-lg:pt-12 max-md:pt-8'>
              ...
              <p className=' lg:max-w-[621px]  z-30 relative opacity-[0.7] font-poppins text-center lg:text-start font-normal text-2xl max-md:text-xl max-sm:text-sm leading-[36px] text-white pt-4'>Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit.Velit officia consequat duis enim velit mollit.</p>
            ...
            <div className=' lg:w-4/12 w-12/12 px-3 flex justify-center  z-30 lg:justify-start'>
              <img src={girl_Img} className=' z-30 relative max-w-[289px]' alt="girl_img" />
            </div>
          </div>
        </div>
      </div>
