...
import footer_Svg_Three from '../assets/image/svg/footer_Ellipse_Three.svg';
import footer_Svg_Four from '../assets/image/svg/footer_Ellips_Four.svg';
const Footer = () => {
  return (
    <div className='bg-footerBg mt-[-2px] bg-cover bg-no-repeat bg-black relative' id='section_6'>
      ...
      <img className='absolute z-0 top-[-332px] max-lg:hidden left-0' src={footer_Svg_Three} alt="footer_Svg_Three" />
      <img className='absolute z-0 top-[30px] max-lg:hidden right-[30px]' src={footer_Svg_Four} alt="footer_Ellips_Three" />
